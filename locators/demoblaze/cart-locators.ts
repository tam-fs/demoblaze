...
export class CartLocators extends CommonLocators {
  ...
  protected initializeLocators(): void {
    ...
    this.deleteButton = this.page.locator('//tbody[@id="tbodyid"]//a[contains(text(),"Delete")]');
  }
  ...
  deleteButtonByProductName(productName: string): Locator {
    ...
    /**
   * Dynamic: find row by product name
   */
  cartItemRowByProductName(productName: string): Locator {
    return this.page.locator(`//tbody[@id="tbodyid"]/tr[td[normalize-space()="${productName}"]]`);
  }
}
